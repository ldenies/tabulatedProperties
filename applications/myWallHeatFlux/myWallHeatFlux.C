...
int main(int argc, char *argv[])
{
    ...
    forAll(timeDirs, timeI)
    {
        ...
        (
            ...
            mesh,
            dimensionedScalar("myWallHeatFlux", heatFlux.dimensions(), 0.0)
        );

        forAll(myWallHeatFlux.boundaryField(), patchi)
        {
            myWallHeatFlux.boundaryField()[patchi] = patchHeatFlux[patchi];
        }
