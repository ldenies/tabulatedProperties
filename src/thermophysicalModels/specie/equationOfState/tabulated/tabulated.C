...
template<class Specie>
void Foam::tabulated<Specie>::write(Ostream& os) const
{
    Specie::write(os);
}
...
template<class Specie>
Foam::Ostream& Foam::operator<<(Ostream& os, const tabulated<Specie>& pg)
{
    os  << static_cast<const Specie&>(pg);

    os.check("Ostream& operator<<(Ostream& os, const tabulated<Specie>& st)");
    return os;
}
