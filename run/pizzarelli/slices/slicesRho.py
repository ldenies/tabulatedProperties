...
a1_rho_PVLookupTable = GetLookupTableForArray( 'rho', 1, RGBPoints=[24.5, 0.0, 0.0, 1.0, 427.0, 1.0, 0.0, 0.0], VectorMode='Magnitude', NanColor=[0.498039, 0.498039, 0.498039], NumberOfTableValues=14, ColorSpace='HSV', ScalarRangeInitialized=1.0 )
a1_rho_PiecewiseFunction = CreatePiecewiseFunction( Points=[24.5, 0.0, 0.5, 0.0, 427.0, 1.0, 0.5, 0.0] )
rho_Isosurfaces =   [24.5, 53.25, 82.0, 110.75, 139.5, 168.25, 197.0, 225.75, 254.5, 283.25, 312.0, 340.75, 369.5, 398.25, 427.0]
DataRepresentation4.ScalarOpacityFunction = a1_rho_PiecewiseFunction
DataRepresentation4.ColorArrayName = ('POINT_DATA', 'rho')
DataRepresentation4.LookupTable = a1_rho_PVLookupTable

Contour1 = Contour( PointMergeMethod="Uniform Binning" )
a1_rho_PVLookupTable.ScalarOpacityFunction = a1_rho_PiecewiseFunction
Contour1.PointMergeMethod = "Uniform Binning"
Contour1.Isosurfaces = rho_Isosurfaces
Contour1.ContourBy = ['POINTS', 'rho']

DataRepresentation5 = Show()
DataRepresentation5.LookupTable = a1_rho_PVLookupTable
...
DataRepresentation12.ScalarOpacityFunction = a1_rho_PiecewiseFunction
DataRepresentation12.ColorArrayName = ('POINT_DATA', 'rho')
DataRepresentation12.LookupTable = a1_rho_PVLookupTable

Contour3 = Contour( PointMergeMethod="Uniform Binning" )
Contour3.PointMergeMethod = "Uniform Binning"
Contour3.Isosurfaces = rho_Isosurfaces
Contour3.ContourBy = ['POINTS', 'rho']

DataRepresentation13 = Show()
DataRepresentation13.LookupTable = a1_rho_PVLookupTable
...
DataRepresentation16.ScalarOpacityFunction = a1_rho_PiecewiseFunction
DataRepresentation16.ColorArrayName = ('POINT_DATA', 'rho')
DataRepresentation16.LookupTable = a1_rho_PVLookupTable

Contour4 = Contour( PointMergeMethod="Uniform Binning" )
Contour4.PointMergeMethod = "Uniform Binning"
Contour4.Isosurfaces = rho_Isosurfaces
Contour4.ContourBy = ['POINTS', 'rho']

DataRepresentation17 = Show()
DataRepresentation17.LookupTable = a1_rho_PVLookupTable
...
DataRepresentation20.ScalarOpacityFunction = a1_rho_PiecewiseFunction
DataRepresentation20.ColorArrayName = ('POINT_DATA', 'rho')
DataRepresentation20.LookupTable = a1_rho_PVLookupTable

Contour5 = Contour( PointMergeMethod="Uniform Binning" )
Contour5.PointMergeMethod = "Uniform Binning"
Contour5.Isosurfaces = rho_Isosurfaces
Contour5.ContourBy = ['POINTS', 'rho']

DataRepresentation21 = Show()
DataRepresentation21.LookupTable = a1_rho_PVLookupTable
...
DataRepresentation24.ScalarOpacityFunction = a1_rho_PiecewiseFunction
DataRepresentation24.ColorArrayName = ('POINT_DATA', 'rho')
DataRepresentation24.LookupTable = a1_rho_PVLookupTable

Contour6 = Contour( PointMergeMethod="Uniform Binning" )
Contour6.Isosurfaces = rho_Isosurfaces
Contour6.ContourBy = ['POINTS', 'rho']

DataRepresentation25 = Show()
DataRepresentation25.LookupTable = a1_rho_PVLookupTable
